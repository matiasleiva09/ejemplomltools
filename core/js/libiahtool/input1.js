	    	...
	    	if(!this.activarTamano)
	    	{
				...
				if(this.tipo!="textarea")
				{
					...
					else
					{
				     ...
				     strHtml+='<textarea class="form-control input-sm" id="'+this.idInput+'" aria-describedby="sizing-addon3"></textarea>';
					 
		    	if(this.obligatorio)
		    	     strHtml+='<span class="form-control-feedback" id="'+this.id+ '_' + this.idInput +'grafic"></span>';	
		    	strHtml+='</div>';
				strHtml+="</div>";
	    	}
	    	else
	    	{
				...
				if(this.tipo!="textarea")
				{
					...
					if(this.dataPickerConHora)
					{
				     ...
				     strHtml+='<textarea class="form-control input-sm" id="'+this.idInput+'"></textarea>';
		    	if(this.obligatorio)
		    	     strHtml+='<span class="form-control-feedback" id="'+this.id+ '_' + this.idInput +'grafic"></span>';	
		    	strHtml+='</div>';
				strHtml+="</div>";
